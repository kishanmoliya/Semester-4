import 'package:first_project/Lab_08/02_custom_Text.dart';
    ...
    return Scaffold(
      ...
      body: Column(
        ...
        children: [
          ...
          card.getUI(context, CustomText(), "2. Write a flutter code to create a custom Text widget with different fonts & use it"),
